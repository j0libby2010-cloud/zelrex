...
export default function SignUpPage() {
  return (
    <div style={{
      ...
      <style>{`
        ...
        * { font-family: 'Inter', system-ui, -apple-system, sans-serif; box-sizing: border-box; }
        ...
        .su-logo {
          ...
          animation: suReveal 800ms cubic-bezier(0.16, 1, 0.3, 1) 100ms forwards;
        }
        .su-card {
          opacity: 0;
          transform: translateY(20px) scale(0.97);
          animation: suReveal 800ms cubic-bezier(0.16, 1, 0.3, 1) 300ms forwards;
        }
        .su-footer {
          opacity: 0;
          transform: translateY(10px);
          animation: suReveal 700ms cubic-bezier(0.16, 1, 0.3, 1) 600ms forwards;
        }
        @keyframes suReveal {
        ...
        .su-momentum {
          ...
          animation: mSweep2 1.2s cubic-bezier(0.25, 0.46, 0.45, 0.94) 400ms forwards;
          margin: 6px auto 0;
        }
        @keyframes mSweep2 {
          0% { width: 0; opacity: 0; }
      ...
      {/* Logo */}
      <div className="su-logo" style={{ marginBottom: 36, textAlign: "center", position: "relative", zIndex: 2 }}>
        <div style={{ display: "inline-block" }}>
          ...
          <div className="su-momentum" style={{ maxWidth: 152, marginLeft: 6 }} />
        </div>
      </div>

      {/* Sign-up card */}
      <div className="su-card" style={{ position: "relative", zIndex: 2, width: "100%", maxWidth: 400 }}>
        <SignUp
          path="/sign-up"
          routing="path"
          signInUrl="/sign-in"
      ...
      {/* Footer */}
      <div className="su-footer" style={{ marginTop: 36, textAlign: "center", position: "relative", zIndex: 2 }}>
