    ...
    <div style={{
      ...
      <style>{`
        ...
        * { font-family: -apple-system, 'SF Pro Display', 'Inter', BlinkMacSystemFont, sans-serif; box-sizing: border-box; }
        ...
        .su-logo    { animation: su-reveal 700ms ${EASE} 100ms both; }
        .su-card    { animation: su-reveal 700ms ${EASE} 280ms both; }
        .su-footer  { animation: su-reveal 600ms ${EASE} 520ms both; }
        ...
        .su-aurora::before {
          ...
          animation: su-aurora 18s ease-in-out infinite alternate;
        }
        @keyframes su-aurora {
        ...
        .su-glow {
          ...
          pointer-events: none;
          animation: su-fadeIn 1.2s ${EASE} 200ms both;
          filter: blur(40px);
        }
      `}</style>
      ...
      <div className="su-accent-line" />

      {/* Logo — exact match from chat header */}
      <div className="su-logo" style={{ marginBottom: 40, textAlign: "center", position: "relative", zIndex: 2 }}>
        <div style={{ display: "inline-block" }}>
          <svg width={156 * 1.1} height={40 * 1.1} viewBox="0 0 156 40" fill="none" style={{ display: "block", marginLeft: 4 }}>
            ...
            <rect x="2" y="29" width="140" height="6" rx="3" fill="url(#wgrad-su)" />
            <defs>
              <linearGradient id="wgrad-su" x1="2" y1="32" x2="142" y2="32" gradientUnits="userSpaceOnUse">
      ...
      {/* Sign-up card — liquid glass wrapper */}
      <div className="su-card" style={{ position: "relative", zIndex: 2, width: "100%", maxWidth: 420 }}>
        <div className="su-glow" />
        <div className="su-glass-wrap" style={{
      ...
      {/* Footer */}
      <div className="su-footer" style={{ marginTop: 42, textAlign: "center", position: "relative", zIndex: 2 }}>
        <p style={{
